...
export default function MockupViewer({ colors, mode, onModeChange, paletteName = 'CRAN3O Spec' }: MockupViewerProps) {
  ...
  const renderArchDay = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="250" y="13" fill={textContrast} opacity="0.6" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">5000 mm</text>
        ...
        <text x="12" y="165" fill={textContrast} opacity="0.6" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 12, 165)">3200 mm</text>
        
        <text x="35" y="45" fill={textContrast} opacity="0.5" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">ELEVATION A-A / SCALE 1:50</text>
      </svg>
    );
  };
  ...
  const renderArchNight = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: '#090a0f', borderRadius: '4px' }}>
        ...
        <text x="250" y="13" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">5000 mm</text>

        <line x1="18" y1="30" x2="18" y2="290" stroke={textContrast} strokeOpacity="0.2" strokeWidth="0.8" />
        <text x="12" y="165" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 12, 165)">3200 mm</text>
        
        <text x="35" y="45" fill={textContrast} opacity="0.3" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">ELEVATION A-A (NIGHT) / LIGHT VALUE TEST</text>
      </svg>
    );
  };
  ...
  const renderArchMoodboard = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="25" y="28" fill={textContrast} opacity="0.7" fontSize="9" fontWeight="700" fontFamily="'Blinker', sans-serif">CMF BOARD / SPATIAL MATERIAL SPECIFICATION</text>
        ...
        <g transform="translate(25, 45)">
          ...
          <text x="15" y="222" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">PLASTER / TEXTURE</text>
          <text x="15" y="231" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif">VAL: {wall.toUpperCase()}</text>
        </g>
        ...
        <g transform="translate(175, 45)">
          ...
          <text x="12" y="93" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">SURFACE WALL</text>
          <text x="12" y="102" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif">VAL: {floor.toUpperCase()}</text>
        </g>
        ...
        <g transform="translate(175, 170)">
          ...
          <text x="12" y="93" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">STONE / CONCRETE</text>
          <text x="12" y="102" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif">VAL: {details.toUpperCase()}</text>
        </g>
        ...
        <g transform="translate(330, 45)">
          ...
          <text x="12" y="45" fill="#ffffff" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>ACCENT PRIMARY</text>
          <text x="12" y="54" fill="#ffffff" opacity="0.7" fontSize="7" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>{accent1.toUpperCase()}</text>

          {/* Accent Teal */}
          <rect x="0" y="75" width="145" height="65" fill={accentTeal} rx="3" stroke={textContrast} strokeOpacity="0.15" />
          <text x="12" y="120" fill="#ffffff" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>ACCENT SIGNAL</text>
          <text x="12" y="129" fill="#ffffff" opacity="0.7" fontSize="7" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>{accentTeal.toUpperCase()}</text>

          {/* Accent 2 */}
          <rect x="0" y="150" width="145" height="85" fill={accent2} rx="3" stroke={textContrast} strokeOpacity="0.15" />
          <text x="12" y="215" fill="#ffffff" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>SECONDARY ACCENT</text>
          <text x="12" y="224" fill="#ffffff" opacity="0.7" fontSize="7" fontFamily="'Blinker', sans-serif" style={{ mixBlendMode: 'difference' }}>{accent2.toUpperCase()}</text>
        </g>

        {/* Technical notes */}
        <line x1="25" y1="295" x2="475" y2="295" stroke={textContrast} strokeOpacity="0.15" />
        <text x="25" y="307" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif">{"CRAN3O COLOR LAB SPECIFICATION // OKLCH SYSTEM CONTROL"}</text>
      </svg>
    );
  };
  ...
  const renderIndSpeaker = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="25" y="28" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">ELEVATION & PROFILE: DESKTOP SPEAKER</text>
        ...
        <g transform="translate(60, 50)">
          ...
          <text x="60" y="-10" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">FRONT ELEVATION</text>
        </g>
        ...
        <g transform="translate(260, 50)">
          ...
          <text x="65" y="-10" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">SIDE PROFILE</text>
        </g>
        ...
        <text x="27" y="155" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 27, 155)">200.0 mm</text>
        ...
        <text x="120" y="276" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">120.0 mm</text>
        ...
        <text x="25" y="302" fill={textContrast} opacity="0.35" fontSize="7.5" fontFamily="'Blinker', sans-serif">HOUSING [SRF]: {wall.toUpperCase()}{" // "}DIALS [MUT]: {details.toUpperCase()}</text>
      </svg>
    );
  };
  ...
  const renderIndChair = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        <text x="25" y="28" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">TUBE FRAME LOUNGE CHAIR / CAD SHEET</text>
        ...
        <g transform="translate(60, 60)">
          ...
          <text x="60" y="210" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">ALZADO FRONTAL (FRONT)</text>
        </g>
        ...
        <g transform="translate(260, 60)">
          ...
          <text x="55" y="210" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle">ALZADO LATERAL (PROFILE)</text>
        </g>
        ...
        <text x="27" y="170" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 27, 170)">820.0 mm</text>

        <text x="25" y="302" fill={textContrast} opacity="0.35" fontSize="7.5" fontFamily="'Blinker', sans-serif">CUSHION [ACC1]: {accent1.toUpperCase()}{" // "}SHELL [ACC2]: {accent2.toUpperCase()}{" // "}TUBE [MUT]: {details.toUpperCase()}</text>
      </svg>
    );
  };
  ...
  const renderIndTool = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        <text x="25" y="28" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">DIGITAL CALIPER / CMF METROLOGY INSTRUMENT</text>
        ...
        <g transform="translate(50, 110)">
          ...
          <text x="160" y="43" fill={textContrast} fontSize="12" fontFamily="'Blinker', sans-serif" fontWeight="700" textAnchor="middle">24.08</text>
          <text x="185" y="34" fill={textContrast} fontSize="6" fontFamily="'Blinker', sans-serif">mm</text>
        ...
        <text x="25" y="280" fill={textContrast} opacity="0.4" fontSize="7.5" fontFamily="'Blinker', sans-serif">BEAM [BDR]: {floor.toUpperCase()}{" // "}DISPLAY CASE [TXT]: {shadow.toUpperCase()}{" // "}MOVABLE JAW [SRF]: {wall.toUpperCase()}</text>
  ...
  const renderIndAppliance = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        <text x="25" y="28" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">ESPRESSO MACHINE ELEVATION / DOMESTIC APPLIANCE CMF</text>
        ...
        <text x="120" y="68" fill={textContrast} opacity="0.5" fontSize="7.5" fontFamily="'Blinker', sans-serif" textAnchor="end">BOILER PRESSURE GAUGE</text>

        <line x1="310" y1="140" x2="350" y2="140" stroke={textContrast} strokeOpacity="0.2" strokeWidth="0.8" />
        <text x="355" y="143" fill={textContrast} opacity="0.5" fontSize="7.5" fontFamily="'Blinker', sans-serif" textAnchor="start">PORTAFILTER CMF ACCENT</text>

        <text x="25" y="302" fill={textContrast} opacity="0.35" fontSize="7.5" fontFamily="'Blinker', sans-serif">CHASSIS [SRF]: {wall.toUpperCase()}{" // "}PORTAFILTER [TXT]: {shadow.toUpperCase()}{" // "}FLUIDS [ACC_TL]: {accentTeal.toUpperCase()}</text>
      </svg>
    );
  };
  ...
  const renderGraphPoster = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="35" y="55" fill={textContrast} fontSize="28" fontWeight="900" fontFamily="'Blinker', sans-serif" letterSpacing="-1.5">CRAN3O COLOR</text>
        <text x="35" y="75" fill={accent1} fontSize="14" fontWeight="600" fontFamily="'Blinker', sans-serif" letterSpacing="4">OKLCH CHROMATIC SYSTEM</text>
        ...
        <text x="35" y="220" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">EDITION SWISS GRAPHICS LAB</text>
        <text x="35" y="232" fill={textContrast} opacity="0.6" fontSize="7.5" fontFamily="'Blinker', sans-serif">MAX CHROMA CAP: 0.10 OKLCH</text>
        <text x="35" y="244" fill={accentTeal} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">SYS.ACC_TL: {accentTeal.toUpperCase()}</text>

        <g transform="translate(360, 220)">
          <text x="0" y="0" fill={textContrast} opacity="0.8" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">COLORWEIGHT PROPORTIONS</text>
          ...
          <text x="0" y="24" fill={textContrast} opacity="0.4" fontSize="7" fontFamily="'Blinker', sans-serif">TOTAL SYSTEM HARMONY VALUE: PASS</text>
        </g>
      </svg>
    );
  };
  ...
  const renderGraphDashboard = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: shadow, borderRadius: '4px' }}>
        ...
        <text x="460" y="42" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="end">CRAN3O OS / LABORATORY DASHBOARD</text>
        ...
        <text x="165" y="85" fill={details} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">CORE TEMPERATURE</text>
        <text x="165" y="120" fill={textContrast} fontSize="24" fontWeight="800" fontFamily="'Blinker', sans-serif">38.4</text>
        <text x="235" y="110" fill={textContrast} opacity="0.7" fontSize="10" fontFamily="'Blinker', sans-serif">°C</text>
        ...
        <text x="330" y="85" fill={details} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">HARMONY METRIC</text>
        ...
        <text x="165" y="200" fill={details} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">SYSTEM METRIC</text>
        <text x="165" y="235" fill={textContrast} fontSize="18" fontWeight="800" fontFamily="'Blinker', sans-serif">OKLCH OK</text>
        <text x="165" y="255" fill={textContrast} opacity="0.5" fontSize="7" fontFamily="'Blinker', sans-serif">CONTRAST Lc: 78.5</text>
      </svg>
    );
  };
  ...
  const renderGraphLanding = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="435" y="34" fill="#ffffff" fontSize="6.5" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="middle" style={{ mixBlendMode: 'difference' }}>GET</text>

        <g transform="translate(35, 75)">
          <text x="0" y="30" fill={textContrast} fontSize="22" fontWeight="900" fontFamily="'Blinker', sans-serif" letterSpacing="-1">Quiet Systems.</text>
          <text x="0" y="55" fill={textContrast} fontSize="22" fontWeight="900" fontFamily="'Blinker', sans-serif" letterSpacing="-1">Rams Aesthetic.</text>
          <text x="0" y="80" fill={details} fontSize="9.5" fontWeight="500" fontFamily="'Blinker', sans-serif">OKLCH CHROMA CONTROL ENGINE</text>
          
          <rect x="0" y="115" width="85" height="26" fill={accent1} rx="3" />
          <text x="42.5" y="131" fill="#ffffff" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="middle" style={{ mixBlendMode: 'difference' }}>START LAB</text>

          <rect x="100" y="115" width="85" height="26" fill="none" stroke={details} strokeWidth="1.5" rx="3" />
          <text x="142.5" y="131" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="middle">EXPLORE</text>
        </g>
        ...
        <g transform="translate(290, 75)">
          ...
          <text x="12" y="163" fill={textContrast} opacity="0.5" fontSize="6.5" fontFamily="'Blinker', sans-serif">FIG 01. ENGINE CORE</text>
        </g>
      </svg>
    );
  };
  ...
  const renderGraphPackaging = () => {
    ...
    return (
      <svg viewBox="0 0 500 320" width="100%" height="100%" style={{ background: bg, borderRadius: '4px' }}>
        ...
        <text x="25" y="28" fill={textContrast} opacity="0.6" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif">DIE-CUT PACKAGING SLEEVE / FLAT LAYOUT</text>

        <g transform="translate(30, 45)">
          <rect x="20" y="20" width="90" height="180" fill={floor} stroke={textContrast} strokeOpacity="0.4" strokeDasharray="3,3" />
          <text x="65" y="110" fill={textContrast} opacity="0.4" fontSize="8" fontFamily="'Blinker', sans-serif" textAnchor="middle">REAR COVER</text>

          <rect x="110" y="20" width="30" height="180" fill={floor} stroke={textContrast} strokeOpacity="0.4" strokeDasharray="3,3" />
          <text x="125" y="110" fill={textContrast} opacity="0.4" fontSize="8" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 125, 110)">SPINE A</text>
          ...
          <text x="185" y="45" fill="#ffffff" fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="middle" style={{ mixBlendMode: 'difference' }}>CRAN3O</text>
          ...
          <text x="245" y="110" fill={textContrast} opacity="0.4" fontSize="8" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 245, 110)">SPINE B</text>

          <polygon points="260,30 280,45 280,175 260,190" fill={details} opacity="0.25" stroke={textContrast} strokeOpacity="0.4" />
          <text x="270" y="110" fill={textContrast} opacity="0.3" fontSize="6.5" fontFamily="'Blinker', sans-serif" textAnchor="middle" transform="rotate(-90, 270, 110)">GLUE FLAP</text>

          <path d="M 20 20 L 260 20 M 20 200 L 260 200" stroke={accent1} strokeWidth="1.2" strokeOpacity="0.5" />
        </g>

        <text x="25" y="280" fill={textContrast} opacity="0.4" fontSize="7.5" fontFamily="'Blinker', sans-serif">{"SOLID LINE: CUT // DASHED LINE: FOLD // ACCENT BAND: GLUE"}</text>
  ...
  const renderSpecList = () => {
    ...
    return (
      <svg viewBox="0 0 500 500" width="100%" height="100%" style={{ background: '#ffffff', borderRadius: '4px' }}>
        ...
        <text x="20" y="26" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" letterSpacing="2">CRAN3O COLOR STUDIO</text>
        <text x="480" y="26" fill={textContrast} fontSize="8" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="end" letterSpacing="1">SPEC.02 / SYSTEM PALETTE SHEET</text>
        <text x="20" y="38" fill={textContrast} opacity="0.6" fontSize="9" fontWeight="600" fontFamily="'Blinker', sans-serif">PALETTE: {paletteName.toUpperCase()}</text>
          ...
          if (rowHeight >= 75) {
            ...
            return (
              <g key={color.id}>
                ...
                <text x="340" y={y + rowHeight / 2 + 2 + (lines.length > 1 ? 4 : 0)} fill={textContrast} opacity="0.5" fontSize={hexSize} fontFamily="'Blinker', sans-serif">
                  {color.hex.toUpperCase()}
                </text>

                <rect x="340" y={badgeY} width="50" height={badgeHeight} rx="2" fill="none" stroke={textContrast} strokeOpacity="0.25" strokeWidth="1" />
                <text x="365" y={badgeY + badgeHeight / 2 + 3} fill={textContrast} opacity="0.7" fontSize="7" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="middle" letterSpacing="0.5">
            ...
            return (
              <g key={color.id}>
                ...
                <text x="340" y={y + rowHeight / 2 + 10 + (lines.length > 1 ? 5 : 0)} fill={textContrast} opacity="0.5" fontSize="8.5" fontFamily="'Blinker', sans-serif">
                  {color.hex.toUpperCase()}
                </text>

                <text x="480" y={y + rowHeight / 2 + 4} fill={textContrast} opacity="0.7" fontSize="7.5" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="end">
                  {getRoleAbbreviation(color.role)}
                </text>
            ...
            return (
              <g key={color.id}>
                ...
                <text x="340" y={y + rowHeight / 2 + 8 + (lines.length > 1 ? 4 : 0)} fill={textContrast} opacity="0.5" fontSize="7.5" fontFamily="'Blinker', sans-serif">
                  {color.hex.toUpperCase()}
                </text>

                <text x="480" y={y + rowHeight / 2 + 3} fill={textContrast} opacity="0.7" fontSize="7.5" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="end">
                  {getRoleAbbreviation(color.role)}
                </text>
          ...
          return (
            <g key={color.id}>
              ...
              <g transform={`translate(${x + w/2}, 485) rotate(-90)`}>
                <text x="0" y="-10" fill={textContrast} fontSize="9.5" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="start">
                  {color.displayName}
                </text>
                <text x="0" y="1.5" fill={textContrast} opacity="0.5" fontSize="8.5" fontWeight="500" fontFamily="'Blinker', sans-serif" textAnchor="start">
                  {color.hex.toUpperCase()}
                </text>
                <text x="0" y="11" fill={textContrast} opacity="0.7" fontSize="7" fontWeight="700" fontFamily="'Blinker', sans-serif" textAnchor="start" letterSpacing="0.5">
                  {getRoleAbbreviation(color.role)}
                </text>
              </g>
            </g>
