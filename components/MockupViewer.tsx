...
export default function MockupViewer({ colors, mode, onModeChange, paletteName = 'Quiet Future Spec' }: MockupViewerProps) {
...
const renderSpecList = () => (
  <svg viewBox="0 0 500 500" width="100%" height="100%" style={{ background: '#fcfbfa', borderRadius: '4px' }}>
    ...
    <text x="20" y="26" fill="#000000" fontSize="8" fontWeight="700" fontFamily="'Inter', -apple-system, sans-serif" letterSpacing="2">QUIET FUTURE COLOR STUDIO</text>
